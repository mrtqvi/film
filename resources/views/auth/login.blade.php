@extends('app.layouts.app', ['title' => 'ورود به حساب کاربری'])
@section('content')
    <section>
            ...
            <section class="z-30 w-full md:w-4/5 shadow rounded-lg md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-1 md:p-4">
                    <section class="flex justify-between items-center">
                        <div class="w-full">
                            <a href="{{ route('register') }}" class="font-bold text-gray-600 text-base md:text-2xl">
                                ثبت نام
                            </a>
                            <span class="text-3xl px-2 text-gray-600">|</span>
                            <a href="{{ route('login') }}" class="font-bold text-white text-base md:text-2xl">
                                ورود
                            </a>
                        </div>
                    </section>
