<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown @active('admin.movies') active-sidebar @endactive">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="movie">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('admin.movies.index') }}"><span class="ml-1 item-text">همه سینمایی ها </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('admin.movies.create') }}"><span class="ml-1 item-text">سینمایی جدید</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown @active('admin.sliders') active-sidebar @endactive">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="slider">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('admin.sliders.index') }}"><span class="ml-1 item-text">همه اسلایدر ها </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('admin.sliders.create') }}"><span class="ml-1 item-text">اسلایدر جدید</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown @active('admin.comments') active-sidebar @endactive">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="comments">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('admin.comment.index') }}"><span class="ml-1 item-text">همه نظرات </span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item dropdown @active('admin.users') active-sidebar @endactive">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="users">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('admin.users.index') }}"><span class="ml-1 item-text">همه کاربران </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('admin.users.create') }}"><span class="ml-1 item-text">کاربر جدید</span></a>
                    </li>
                </ul>
            </li>
        </ul>
