@extends('admin.layouts.app', ['title' => ' دسته بندی ها'])
    ...
    <div class="row justify-content-center">
        <div class="col">
            <h2 class="h3 mb-0 page-title">دسته بندی ها
                <span class="text-sm text-muted">({{ $categories->total() }})</span>
            </h2>
        </div>
        <div class="col-auto">
            <a href="{{ route('admin.categories.create') }}" type="button" class="btn btn-primary px-4">ایجاد</a>
        </div>
        <div class="col-12">
                            ...
                            <table class="table table-striped" id="table-id">
                                ...
                                @forelse($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <small>{{ Str::limit($category->name, 100, '...') }}</small>
                                        </td>
                                        <td>{{ jalaliDate($category->created_at) }}</td>
                                        <td>
                                            <a href="{{ $category->show() }}" target="_blank"
                                ...
                                @empty
                                    <p class="text-center text-muted">هیچ دسته بندی وجود ندارد.</p>
                                @endforelse
                            </table>
