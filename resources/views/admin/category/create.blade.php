@extends('admin.layouts.app', ['title' => ' ایجاد دسته بندی جدید'])
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-12 my-2">
                                <input type="text" name="name" value="{{ old('name') }}" onkeyup="copyToSlug(this)"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="main-pic">
                            ...
                            <img src="{{ asset('images/default/no-photo.png') }}" id="output">
                        </div>
                    </div>
