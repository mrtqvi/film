@extends('admin.layouts.app', ['title' => ' فیلم های سینمایی'])
...
@section('content')
    <div class="row justify-content-center">
        <div class="col">
            <h2 class="h3 mb-0 page-title">فیلم های سینمایی
                <span class="text-sm text-muted">({{ $movies->total() }})</span>
            </h2>
        </div>
        <div class="col-auto">
            <a href="{{ route('admin.movies.create') }}" type="button" class="btn btn-primary px-4">ایجاد</a>
        </div>
        <div class="col-12">
                    ...
                    <div class="card shadow">
                        <div class="card-body table-responsive">
                            ...
                            <table class="table table-striped" id="table-id">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" x-data="{{ $movie->id }}"
                                ...
                                @empty
                                    <p class="text-center text-muted">هیچ فیلمی وجود ندارد.</p>
                                @endforelse
                            </table>
