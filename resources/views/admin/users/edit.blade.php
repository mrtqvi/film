            ...
            <div class="col-12 col-md-9 mx-auto pr-2 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-6 my-2">
                                        ...
                                        <select name="is_admin" class="form-control custom-focus" id="is_admin">
                                            <option value="0" @selected(old('is_admin' , $user->is_admin) == 0)>کاربر عادی</option>
                                            <option value="1" @selected(old('is_admin' , $user->is_admin) == 1)>مدیر</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-row">
                        ...
                        <div class="form-row">
                            <button type="submit" class="btn btn-primary px-4 mt-3">ویرایش</button>
                        </div>
                    </div>
                </div> 
            </div>
