...
@section('content')
    <div class="row d-flex justify-content-between">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h3 mb-0 section-heading">ایجاد سریال جدید</h2>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12 my-2">
                                ...
                                <select class="js-example-basic-multiple form-control custom-input-size custom-focus"
                                    name="categories[]" id="categories" multiple="multiple">
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" @selected(in_array($category->id, old('categories', old('categories') ?? [])))>
                                            {{ $category->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-12 my-2 mb-0">
                            ...
                            <div class="form-group col-md-4 my-2">
                                ...
                                <input type="text" name="country" value="{{ old('country') }}" placeholder="کشور سازنده"
                            ...
                            <div class="form-group col-md-4 my-2">
                                ...
                                <input type="number" name="imdb" step="any" value="{{ old('imdb') }}"
                            ...
                            <div class="form-group col-md-4 my-2">
                                ...
                                <input type="number" name="ages" value="{{ old('ages') }}"
                            ...
                            <div class="form-group col-md-4 my-2">
                                ...
                                <input type="number" name="year_construction" value="{{ old('year_construction') }}"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column mt-2">
                            ...
                            <video id="videoPreview" src="{{ old('teaser') ? URL::to('/') . '/' . old('teaser') : '' }}"
                                controls class="{{ old('teaser') ? 'block' : 'd-none' }} mt-3"
