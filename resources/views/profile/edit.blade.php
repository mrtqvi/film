@extends('app.layouts.app', ['title' => ' تنظیمات حساب'])
...
@section('content')
    ...
    @if ($errors->any())
        <div
            class="p-4 mb-4  text-sm text-red-600 w-full  rounded-lg  bg-gray-800  flex flex-col"
            role="alert">
    ...
    <form class="" action="{{ route('profile.destroy') }}" method="post">
        @csrf
        @method('DELETE')
        <button
