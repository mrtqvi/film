                ...
                <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                    <div class="relative transition-all w-full h-full max-w-md md:h-auto">
                        ...
                        <div class="relative  rounded-lg shadow bg-low-dark border border-green-800">
                            <button type="button" class="absolute top-3 left-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="authentication-modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                <span class="sr-only">Close modal</span>
                            </button>
                            <div class="px-6 py-6 lg:px-8">
                                <div class="space-y-3">
                                    <h3 class="text-sm flex justify-center mt-4 font-medium text-gray-900 dark:text-white">اگر در فال و فیلم حساب کاربری ندارید ثبت نام کنید!؟</h3>
                                    <a href="{{ route('register') }}" type="submit" class="w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-green-500 hover:bg-green-600 focus:ring-green-800">ثبت نام</a>
                                </div>
                                <div class="space-y-3 mt-5">
                                    <h3 class="text-sm flex justify-center mt-4 font-medium text-gray-900 dark:text-white">اگر در فال و فیلم حساب کاربری وارد شوید:</h3>
                                    <a href="{{ route('login') }}" type="submit" class="w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-green-500 hover:bg-green-600 focus:ring-green-800">ورود</a>
                                </div>
                            </div>
                        </div>
                    </div>
