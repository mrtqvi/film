<div class="grid grid-cols-12 gap-3 px-3 md:px-6 my-5">
    <div class="flex justify-center bg-main rounded col-span-full lg:col-span-6 relative">
        <div class="absolute flex text-xs left-5 top-4 space-x-1 space-x-reverse z-40">
            <a href="./gener-show.html" class="px-2 rounded-xl py-0.5 bg-slate-800">اکشن</a>
            <a href="./gener-show.html" class="px-2 rounded-xl py-0.5 bg-slate-800">درام</a>
            <a href="./gener-show.html" class="px-2 rounded-xl py-0.5 bg-slate-800">ترسناک</a>
        </div>
        <div class="flex items-center rounded-lg shadow border border-gray-800 md:max-w-full md:flex-row relative">
            <img class="w-52 h-56 object-cover rounded-3xl p-4"
                 src="./../assets/images/The-Batman-2022-Movie-Poster-01.jpg" alt="" />
            <span class="dir-ltr text-white border border-slate-50 mt-1 absolute bottom-6 right-6 w-8 h-8 pt-1 px-0.5 rounded-full bg-yellow-500 text-center">+13</span>
