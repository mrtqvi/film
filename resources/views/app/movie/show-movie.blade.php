<section>
    <div class="w-full h-[450px]">
        <img src="../assets/images/dune-review-scaled.jpg" class="w-full h-[400px]  object-cover relative" alt="">
                    ...
                    <div class="flex col-span-12 w-auto">
                        <div
                            ...
                            <div class="pl-1 flex justify-center items-center">
                                <p
                                    class="text-white md:mr-3 md:mt-2 md:text-xl sm:text-sm text-xs text-center font-bold z-50">
                                    126 دقیقه</p>
                            </div>
                        </div>
                        <div
                        ...
                        <div
                            ...
                            <div class="pl-1 flex justify-center items-center">
                                <p
                                    class="text-white md:mr-3 md:mt-2 md:text-3xl sm:text-sm text-xs  text-center font-bold z-50">
                                    10+</p>
                            </div>
                        </div>
                        <div
...
<div class="grid grid-cols-12 gap-6 mt-16">
    <div class="lg:col-span-6 col-span-12   flex flex-wrap">
        <div class="">
            <div class="flex md:mr-10 mr-5">
                <img src="../assets/images/dune-timothee-chalamet.jpg"
                     class="w-[140px] h-[170px] md:flex  object-cover rounded-lg" alt="">
                <div class="">
        ...
        <div class="mt-7 ml-10 md:mr-10 mr-5">
            ...
            <p class="text-gray-400 mt-1 font-semibold w-dull">
                داستان این مجموعهٔ تلویزیونی در مورد دو برادر است که یکی از آنها برای قتلی که انجام نداده به اعدام
                محکوم شده ...
            </p>
        </div>
    </div>
    <div class="lg:col-span-6  col-span-12 md:mr-10 md:ml-5 mr-5 ml-5 md:mt-0 mt-7 flex flex-wrap">
        <div class="w-full h-64">
            <img src="../assets/images/dune-2.jpg" class="w-full h-64 rounded-lg object-cover" alt="">
        </div>
    </div>
</div>
<!-- cast -->
    ...
    <div class="swiper">
        <section class="slide-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/rio.PNG"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">ریو</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/monika.PNG"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">مونیکا</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/porfosor.PNG"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">پرفسور</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/selena.jpg"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">پرفسور</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/shakira.jpg"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">پرفسور</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/brlin.PNG"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">پرفسور</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/tabrizi.jpg"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">پرفسور</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/yorgen.jpg"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">پرفسور</p>
                </div>
                <div class="swiper-slide">
                    <div class="flex justify-center">
                        <img src="../assets/images/tokio.PNG"
                             class="rounded-full md:w-20 md:h-20 w-14 h-14 flex justify-center items-center object-cover" alt="">
                    </div>
                    <p class="text-white flex justify-center text-center items-center">پرفسور</p>
                </div>
            ...
            <footer class="flex justify-between items-center mb-2">
                <div class="flex items-center">
                    <p class="inline-flex items-center ml-3 text-sm text-white"><img
                            ...
                            alt="Michael Gough">یاسین تقوی</p>
                    <p class="text-sm text-gray-400"><time pubdate datetime="2022-02-08"
                                                           title="February 8th, 2022">18 اسفند 1401</time></p>
                </div>
            </footer>
            <p class="text-gray-500 dark:text-gray-400">من این داستان دوست دارم چون کسشر محظه به نظرم فال و فیلم ریده به هرچی فیلمای خارجی من فقط عاشق فیلمای ایرانیم ارعععععععععع میتونی دبخوریش؟؟</p>
