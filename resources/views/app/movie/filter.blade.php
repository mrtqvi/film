<div class="flex flex-wrap justify-between items-center mx-6 my-8">
    ...
    <div class="flex flex-wrap justify-between">
        <label class="relative inline-flex items-center mr-5 cursor-pointer my-2">
            ...
            <div class="w-11 h-6 rounded-full peer bg-gray-700 peer-focus:ring-4 peer-focus:ring-yellow-300 dark:peer-focus:ring-yellow-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-yellow-400"></div>
        </label>
        <label class="relative inline-flex items-center mr-5 cursor-pointer my-2">
