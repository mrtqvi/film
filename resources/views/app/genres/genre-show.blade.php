<div class="flex flex-wrap gap-2 px-3 md:px-6 mt-5">
    <div class="relative">
        <img class="h-14 w-24 md:h-20 md:w-full transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
             src="../assets/images/geners/action.jpg" alt="image description">
        <div class="absolute bottom-3 w-full text-center drop-shadow-2xl text-gray-50 text-xs md:text-sm">
            اکشن</div>
    </div>
    <div class="relative">
        <img class="h-14 w-24 md:h-20 md:w-32 transition-all duration-300 rounded-lg border border-green-400 pointer-events-none"
             src="../assets/images/geners/scary.webp" alt="image description">
        <div class="absolute bottom-3 w-full text-center drop-shadow-2xl text-gray-50 text-xs md:text-sm">
            ترسناک</div>
    </div>
    <div class="relative">
        <img class="h-14 w-24 md:h-20 md:w-32 transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
             src="../assets/images/geners/Exciting.jpg" alt="image description">
        <div class="absolute bottom-3 w-full text-center drop-shadow-2xl text-gray-50 text-xs md:text-sm">
            هیجانی</div>
    </div>
    <div class="relative">
        <img class="h-14 w-24 md:h-20 md:w-32 transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
             src="../assets/images/geners/drama.jpg" alt="image description">
        <div class="absolute bottom-3 w-full text-center drop-shadow-2xl text-gray-50 text-xs md:text-sm">
            درام</div>
    </div>
    <div class="relative">
        <img class="h-14 w-24 md:h-20 md:w-32 transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
             src="../assets/images/geners/friends.jpg" alt="image description">
        <div class="absolute bottom-3 w-full text-center drop-shadow-2xl text-gray-50 text-xs md:text-sm">
            کمدی</div>
    </div>
    <div class="relative">
        <img class="h-14 w-24 md:h-20 md:w-32 transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
             src="../assets/images/geners/animation.webp" alt="image description">
        <div class="absolute bottom-3 w-full text-center drop-shadow-2xl text-gray-50 text-xs md:text-sm">
            انیمیشن</div>
    </div>
    <div class="relative">
        <img class="h-14 w-24 md:h-20 md:w-32 transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
             src="../assets/images/geners/mostanad.jpg" alt="image description">
        <div class="absolute bottom-3 w-full text-center drop-shadow-2xl text-gray-50 text-xs md:text-sm">
            مستند</div>
    </div>
</div>
<div class="flex justify-between items-center mx-6 my-8">
    <div>
        <h2 class="font-bold">ژانر ترسناک</h2>
        <span class="text-xs text-gray-600">چینش بر اساس جدیدترین ها</span>
    </div>

    <ul
        class="flex flex-wrap text-sm font-medium text-center text-gray-400">
        <li>
            <a href="#film" aria-current="page"
               class="inline-block p-2 text-sm w-16 rounded-r-full bg-gray-800 border border-slate-600 active-tab">فیلم </a>
        </li>
        <li>
            <a href="#serial"
               class="inline-block p-2 text-sm w-16 rounded-l-full bg-gray-800 border border-slate-600">سریال</a>
        </li>
    </ul>
...
<div class="grid grid-cols-12 gap-3 px-3 md:px-6 my-5">
    <div class="flex justify-center bg-main rounded col-span-full lg:col-span-6 relative">
        <span class="px-1 py-0.5 bg-slate-800 absolute rounded-xl text-xs left-3 top-3">62 قسمت</span>
        <div class="flex items-center rounded-lg shadow border border-gray-800 md:max-w-full md:flex-row">
            <img class="w-36 h-48 object-cover rounded-3xl p-4" src="./../assets/images/1.jpg" alt="" />
            <div class="flex flex-col justify-start p-6">
                <h5 class="mb-2 text-gray-400">
                    افسارگسیخته | breaking bad
                </h5>
                <p class="mb-4 text-xs text-gray-500 leading-6">
                    خلاصه داستان : داستان این مجموعهٔ تلویزیونی در مورد دو برادر است که یکی از آنها برای
                    قتلی که انجام نداده به اعدام محکوم شده ...
                </p>
    ...
    <div class="flex justify-center bg-main rounded col-span-full lg:col-span-6 relative">
        <div class="flex items-center rounded-lg shadow border border-gray-800 md:max-w-full md:flex-row">
            <img class="w-36 h-48 object-cover rounded-3xl p-4"
                 src="./../assets/images/The-Batman-2022-Movie-Poster-01.jpg" alt="" />
            <div class="flex flex-col justify-start p-6">
                <h5 class="mb-2 text-gray-400">
                    بتمن | batman
                </h5>
    ...
    <div class="flex justify-center bg-main rounded col-span-full lg:col-span-6 relative">
        <div class="flex items-center rounded-lg shadow border border-gray-800 md:max-w-full md:flex-row">
            <img class="w-36 h-48 object-cover rounded-3xl p-4" src="./../assets/images/2.jpg" alt="" />
            <div class="flex flex-col justify-start p-6">
                <h5 class="mb-2 text-gray-400">
                    بتمن | batman
                </h5>
    ...
    <div class="flex justify-center bg-main rounded col-span-full lg:col-span-6 relative">
        ...
        <div class="flex items-center rounded-lg shadow border border-gray-800 md:max-w-full md:flex-row">
            <img class="w-36 h-48 object-cover rounded-3xl p-4"
                 src="./../assets/images/snh_online_6072x9000_posed_01.jpg" alt="" />
            <div class="flex flex-col justify-start p-6">
                <h5 class="mb-2 text-gray-400">
                    افسارگسیخته | breaking bad
                </h5>
    ...
    <div class="flex justify-center bg-main rounded col-span-full lg:col-span-6 relative">
        <div class="flex items-center rounded-lg shadow border border-gray-800 md:max-w-full md:flex-row">
            <img class="w-36 h-48 object-cover rounded-3xl p-4" src="./../assets/images/100.jpg" alt="" />
            <div class="flex flex-col justify-start p-6">
                <h5 class="mb-2 text-gray-400">
                    بتمن | batman
                </h5>
