<!-- start swiper slider movie-->
<div class="p-6">
    <section class="flex items-center justify-between col-span-12 border-r-4 mb-5 border-[#1AFF23] ">
        <span class="flex items-center font-bold text-white mr-3 ">ویژه</span>
    </section>
            ...
            <section class="card-wrapper swiper-wrapper w-52 h-72">
                <section class="swiper-slide flex ">
                    <a href="#" class="flex justify-center w-full absolute">
                        <img src="{{ asset('images/default/no-photo.png') }}"
                        ...
                        <div
                            ...
                            <div class="absolute top-10 flex flex-col text-center text-white w-full">
                                <strong class="font-bold">the 100</strong>
                                <small class="text-xs text-gray-400">اکشن ، درام ، ماجراجویی</small>
                ...
                <section class="swiper-slide flex ">
                    <a href="#" class="flex justify-center w-full absolute">
                        ...
                        <div
                            class="transition-all flex z-50 bg-black rounded-lg opacity-0 hover:opacity-75 bottom-0 right-0 absolute w-full h-full">
                            <div class="absolute top-10 flex flex-col text-center text-white w-full">
                                <strong class="font-bold">breaking bad</strong>
                                <small class="text-xs text-gray-400">اکشن ، درام ، ماجراجویی</small>
                                <div class="text-xs text-gray-400 flex justify-between mt-4 mx-7">
                                    <div class="flex justify-between items-center w-full">
                                        <div class="flex">
                ...
                <section class="swiper-slide flex ">
                    <a href="#" class="flex justify-center w-full absolute">
                        ...
                        <div
                            class="transition-all flex z-50 bg-black rounded-lg opacity-0 hover:opacity-75 bottom-0 right-0 absolute w-full h-full">
                            <div class="absolute top-10 flex flex-col text-center text-white w-full">
                                <strong class="font-bold">el capino</strong>
                                <small class="text-xs text-gray-400">اکشن ، درام ، ماجراجویی</small>
                                <div class="text-xs text-gray-400 flex justify-between mt-4 mx-7">
                                    <div class="flex justify-between items-center w-full">
                                        <div class="flex">
                ...
                <section class="swiper-slide flex ">
                    <a href="#" class="flex justify-center w-full absolute">
                        ...
                        <div
                            class="transition-all flex z-50 bg-black rounded-lg opacity-0 hover:opacity-75 bottom-0 right-0 absolute w-full h-full">
                            <div class="absolute top-10 flex flex-col text-center text-white w-full">
                                <strong class="font-bold">money heist</strong>
                                <small class="text-xs text-gray-400">اکشن ، درام ، ماجراجویی</small>
                                <div class="text-xs text-gray-400 flex justify-between mt-4 mx-7">
                                    <div class="flex justify-between items-center w-full">
                                        <div class="flex">
                ...
                <section class="swiper-slide flex ">
                    <a href="#" class="flex justify-center w-full absolute">
                        <img src="../assets/images/The-Batman-2022-Movie-Poster-01.jpg"
                             class="object-cover relative rounded-lg  h-64 w-52" alt="">
                        <div
                            class="transition-all flex z-50 bg-black rounded-lg opacity-0 hover:opacity-75 bottom-0 right-0 absolute w-full h-full">
                            <div class="absolute top-10 flex flex-col text-center text-white w-full">
                                <strong class="font-bold">batman</strong>
                                <small class="text-xs text-gray-400">اکشن ، درام ، ماجراجویی</small>
                                <div class="text-xs text-gray-400 flex justify-between mt-4 mx-7">
                                    <div class="flex justify-between items-center w-full">
                                        <div class="flex">
                ...
                <section class="swiper-slide flex ">
                    <a href="#" class="flex justify-center w-full absolute">
                        <img src="../assets/images/snh_online_6072x9000_posed_01.jpg"
                             class="object-cover relative rounded-lg  h-64 w-52" alt="">
                        <div
                            class="transition-all flex z-50 bg-black rounded-lg opacity-0 hover:opacity-75 bottom-0 right-0 absolute w-full h-full">
                            <div class="absolute top-10 flex flex-col text-center text-white w-full">
                                <strong class="font-bold">spiderman</strong>
                                <small class="text-xs text-gray-400">اکشن ، درام ، ماجراجویی</small>
                                <div class="text-xs text-gray-400 flex justify-between mt-4 mx-7">
                                    <div class="flex justify-between items-center w-full">
                                        <div class="flex">
